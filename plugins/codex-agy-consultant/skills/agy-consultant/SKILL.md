...
3. Select only relevant context files with repeated `--path` arguments. The wrapper automatically includes safe tracked changes; it fails instead of truncating an oversized bundle.
